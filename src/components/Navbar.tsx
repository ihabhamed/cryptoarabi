    ...
    <nav className="fixed w-full z-50 bg-crypto-darkBlue/80 backdrop-blur-md border-b border-white/10">
      <div className="container-custom mx-auto flex justify-between items-center py-4">
        ...
        <div className="flex items-center">
          <a href="#" className="text-2xl font-bold text-white">كريبتو<span className="text-crypto-orange">عرب</span></a>
        </div>

        {/* Desktop Menu */}
        <div className="hidden md:flex items-center space-x-1 space-x-reverse">
          <a href="#" className="px-3 py-2 text-white hover:text-crypto-orange transition-colors">الرئيسية</a>
          ...
          <a href="#" className="px-3 py-2 text-white hover:text-crypto-orange transition-colors">تواصل معنا</a>
        </div>
      ...
      {isOpen && (
        <div className="md:hidden bg-crypto-darkGray glass-morphism animate-slide-in-right">
          <div className="px-2 pt-2 pb-3 space-y-1">
            <a href="#" className="block px-3 py-2 text-white hover:text-crypto-orange transition-colors">الرئيسية</a>
            ...
            <a href="#" className="block px-3 py-2 text-white hover:text-crypto-orange transition-colors">تواصل معنا</a>
